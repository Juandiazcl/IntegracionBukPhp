...
if($_POST['type']=='allCC2'){
	$array = executeSelect("SELECT * FROM LaboresBuk ORDER BY code");
	...
	$cc2 = $_POST['cc2'];
	$array = executeSelect("SELECT * FROM LugaresBuk ORDER BY code");
	...
	$cc2 = $_POST['cc2'];
	$cc3 = $_POST['cc3'];
	//$array = executeSelect("SELECT * FROM UnidadBuk ORDER BY code");
