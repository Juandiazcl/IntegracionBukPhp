...
executeSql("DELETE FROM CCXempleado");
...
LEFT JOIN LugaresBuk as Lg on lg.id_lugar=t.idLug)
LEFT JOIN CCBuk as cc on cc.id=Lg.id_centro_costo)
WHERE YEAR(T.fechatj)=".$an." AND MONTH(T.fechatj)=".$mes." and t.cc1trt='".trim($campoBuk)."' and idTar>2 and t.rut_per=".$arrayCC[$i]['rut_per']."";
