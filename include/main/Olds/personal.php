	...
	var idList = 1;
		...
		function loadRegistros(){
			$("#tablaRegistros").html('<thead><tr>' +
				...
				'<th data-dynatable-column="lastname1">Paterno</th>' +
				'<th data-dynatable-column="lastname2">Materno</th>' +
			...
			$.post('../../phps/personal_Load.php', {type: "all", filter: ""/*$("#txtFilter").val()*/}, function(data, textStatus, xhr) {
				...
				if(data!=0){
					...
					var list = "";
					$("#tablaRegistrosExcel").html('<tr><th>Empresa</th><th>RUT</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>Nombres</th><th>Estado</th></tr>');
