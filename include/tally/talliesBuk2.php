	...
	if(userProfile=='ADM'){
		...
		$(document).ready(function() {
			...
			$("#btnAddPersonal").click(function() {
				...
				var row = '<tr>' +
							...
							'<td style="width: 25%; overflow: hidden;"><select id="listLabour'+rowNumber+'" class="focused" data-live-search="true" data-width="fit" data-size="5" data-style="btn btn-default btn-xs" data-container="body">'+listLabour+'</select></td>' +
							...
							'<td style="width: 10%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,1,0,0)"></input></td>' +
							'<td style="width: 10%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,1,0,0)"></input></td>' +
							'<td style="width: 14%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,1,0,0)"></input></td>' +
							'<td style="width: 14%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,50000,0,0)"></input></td>' +
							'<td style="width: 14%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,'+maxExtraHours+',0,1)"></input></td>' +
				...
				if(total>0){
					...
					$('#tableTallyBody > tr').each(function() {
						...
						if($("#listPersonal"+rowNumber).val() in arrayList ){
							arrayList[$("#listPersonal"+rowNumber).val()]['jornadatj'] += parseFloat($($($(this).children()[7]).children()[0]).val());
						}else{
				...
				if(data!=0){
					...
					for(i=0;i<data.length;i++){
						...
						var row = '<tr>' +
									'<td style="width: 2%; overflow: hidden;"><input type="checkbox" class="focused"></input></td>' +
									'<td style="width: 2%; overflow: hidden;">'+rowNumber+'</td>' +
									'<td style="width: 26%; overflow: hidden;"><select id="listPersonal'+rowNumber+'" class="focused" data-live-search="true" data-width="fit" data-size="5" data-style="btn btn-default btn-xs" data-live-search-style="btn btn-default btn-xs" data-container="body">'+listPersonal+'</select></td>' +
									'<td style="width: 20%; overflow: hidden;"><select id="listLabour'+rowNumber+'" class="focused" data-live-search="true" data-width="fit" data-size="5" data-style="btn btn-default btn-xs" data-container="body">'+listLabour+'</select></td>' +
									...
									'<td style="width: 10%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,1,0,0)" value="'+data[i]["nomPro"]+'"></input></td>' +
									'<td style="width: 10%; overflow: hidden;"><input class="form-control input-sm numbersOnlyFloat2 focused" style="text-align: right;" onfocusout="verifyValue(this,this.value,1,0,0)" value="'+data[i]["nomUni"]+'"></input></td>' +
						...
						$("#listPersonal"+rowNumber).selectpicker();
						$("#listLabour"+rowNumber).val(data[i]["idLab"]);
						alert(data[i]["idLab"]);
		...
		function loadLabour(){
			$.post('../../phps/labourBUK_Load.php', {
				...
				var data = JSON.parse(data);
				for(i=0;i<data.length;i++){
					listLabour += '<option value="'+data[i]["id"]+'">'+data[i]["descriptionL"]+'</option>';
				}
			});
		}
		...
		function calculateTotal(){
			...
			$('#tableTallyBody > tr').each(function() {
				...
				val1 += toNoSeparatorFloat($($($(this).children()[4]).children()[0]).val());
				val2 += toNoSeparatorFloat($($($(this).children()[5]).children()[0]).val());
				val3 += toNoSeparatorFloat($($($(this).children()[6]).children()[0]).val());
