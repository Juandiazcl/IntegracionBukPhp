...
/*
						...
						$.post('../../phps/settlement_Load.php', {type: "salary", list: list, endDate: $('#txtFireDate').val()}, function(data, textStatus, xhr) {
							...
							$('#tableSelected > tbody > tr').each(function() {
								...
								if(duration!=1){//Si contrato no es indefinido, se calcula indemnización por mes trabajado
									$($(this).children()[16]).html('<input type="checkbox" />'+parseInt(months*(salaryBase+salaryGratification+salaryCollation+salaryMobilization)/30));
								}else{
		...
		function loadData(){
			...
			$.post('../../phps/settlement_Load.php', {type: "allHistoric", plant: plant, startDate: $("#txtDateStart").val(), endDate: $("#txtDateEnd").val()}, function(data, textStatus, xhr) {
				console.log(data);
				if(data!=0){
					var data = JSON.parse(data);
	...
	<div class="container-fluid">
		<div class="row">
			<div class="panel panel-primary">
				<div class="panel-heading"><i class="fa fa-user-times fa-lg fa-fw"></i><i class="fa fa-clock-o fa-fw"></i>&nbsp;&nbsp; Finiquitos Históricos</div>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
							...
							<div class="input-group input-group-sm">
								<input id="txtDateStart" type="text" class="form-control datepickerTxt dateFilter">
						...
						<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
							...
							<div class="input-group input-group-sm">
								<input id="txtDateEnd" type="text" class="form-control datepickerTxt dateFilter">
								<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></span>
							</div>
						</div>
