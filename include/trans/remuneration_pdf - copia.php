...
$sql = "SELECT 
		...
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='P001'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS days_total,
		
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='H035'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS total_h,
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='D045'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS total_d,
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='H045'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS total_rem,
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='D026'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS total_advance,
		(SELECT r2.valrem2 FROM REM021 r2 WHERE codhdrem='H046'
		AND r2.aaaarem=r.aaaarem AND r2.mmrem=r.mmrem AND r2.cc1rem=r.cc1rem AND r2.rutrem=r.rutrem) AS total_topay,
...
for($i=0;$i<count($arrayPersonal);$i++){
	...
	$htmlHead = '<tr>
				...
				<tr>
					...
					<td colspan="3">'.number_format($arrayPersonal[$i]['days_total'],0,'','.').'</td>
				</tr>
				<tr>
