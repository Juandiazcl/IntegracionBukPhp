...
$htmlFullAll = '';
$rut = $_GET['rut'];
//6313236,8690250,4449905,5519979,12089945,12786298
$sql = "SELECT fp.ID
		FROM FERIADO_PROPORCIONAL fp WHERE fp.Rut IN ($rut)
		ORDER BY fp.Rut, fp.Fecha_Inicio";

$arrayRut = executeSelect($sql);

for($z=0;$z<count($arrayRut);$z++){
//for($z=0;$z<10;$z++){
	$id = $arrayRut[$z]['ID'];
	...
	$htmlBody2 = '<tr>
				...
				<tr>
					<td colspan="6" style="font-weight: bold;">Días pendientes a la fecha de inicio de vacaciones</td>
					<td colspan="4" style="font-weight: bold;">'.$daysPending.'&nbsp;días hábiles</td>
					<td colspan="2"></td>
				</tr>
				';
	...
	$htmlFullAll .= '<table align="center" style="width: 90%; font-size: 13px; font-family: arial, sans-serif; table-layout: fixed;">'.$htmlHead.$htmlBody1.$htmlBody2.$htmlBody3.'<tr><td colspan="6"><br/></td></tr>'.$htmlFooter.'</table><div style="page-break-before: always;"></div>';
